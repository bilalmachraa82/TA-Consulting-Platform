    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {data?.empresas?.map((empresa, index) => (
          ...
          >
            <Card className="hover:shadow-lg transition-shadow cursor-pointer dark:bg-slate-800 dark:border-slate-700 dark:hover:bg-slate-700/80">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle className="text-lg mb-1 dark:text-gray-100">{empresa.nome}</CardTitle>
                    <div className="flex items-center gap-2 mb-2">
                      <code className="text-sm bg-gray-100 dark:bg-slate-900 dark:text-gray-300 px-2 py-1 rounded">{empresa.nipc}</code>
              ...
              <CardContent className="space-y-3">
                ...
                {/* Estatísticas */}
                <div className="border-t pt-3 grid grid-cols-2 gap-2 text-sm dark:border-slate-700 dark:text-gray-300">
                ...
                {empresa.contactoNome && (
                  <div className="border-t pt-2 text-sm dark:border-slate-700">
                    <div className="font-medium dark:text-gray-200">{empresa.contactoNome}</div>
                    {empresa.contactoEmail && (
                      <div className="text-gray-500 dark:text-gray-400">{empresa.contactoEmail}</div>
                    )}
                  </div>
                )}
              </CardContent>
