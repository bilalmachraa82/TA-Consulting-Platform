    ...
    <div className="space-y-6 p-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {Array.isArray(recomendacoes) && recomendacoes.map((recomendacao) => {
                  ...
                  {razoes.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1 ml-6">
                        {Array.isArray(razoes) && razoes.map((razao: string, index: number) => (
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        <ul className="space-y-1">
                          {Array.isArray(alertas) && alertas.map((alerta: string, index: number) => (
