        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/diagnostico-fundos" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
                Diagnóstico Grátis
              </Link>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-4">
            ...
            <Link href="/apresentacao">
              <Button size="lg" variant="outline" className="bg-white border-blue-600 text-blue-700 hover:bg-blue-50 px-8 py-4 text-lg">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100">
              ...
              <CardContent className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600 mb-6">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 text-green-600 mr-2 flex-shrink-0" />
                    Gestão pós-aprovação (milestones)
                  </li>
                </ul>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/dashboard">
              <Button size="lg" variant="outline" className="bg-white border-green-600 text-green-700 hover:bg-green-50 px-8 py-4">
